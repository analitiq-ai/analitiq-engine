...
def _get_sqlalchemy_dialect(dialect: str, paramstyle: str | None = None) -> SADialect:
...
def build_select_query(
    ...
    Args:
        dialect: Database dialect string from config
            (e.g., 'postgresql', 'postgres', 'mysql')
    ...
    Returns:
        Tuple of (query_string, params) where params is a positional list
        or a name->value dict depending on the dialect paramstyle.
    """
