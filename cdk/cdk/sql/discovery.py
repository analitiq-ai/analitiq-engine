...
async def list_schemas(
    ...
    *dialect* is the connector's dialect strategy — supplied by the
    ...
    The dialect arrives carrying its connector's declared capabilities
    (:meth:`SqlDialect.for_runtime` settles them at construction), so
    standalone discovery enforces the declared catalog fact identically.
    """
