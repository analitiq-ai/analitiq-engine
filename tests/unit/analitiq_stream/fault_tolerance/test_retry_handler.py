...
class TestRetryHandler:
    ...
    def test_retry_handler_initialization(self):
        ...
        handler = RetryHandler(max_retries=5, base_delay=2.0, max_delay=60.0)
    ...
    async def test_retry_handler_delay_application(self):
        ...
        async def failing_operation():
            call_times.append(datetime.now(tz=timezone.utc))
        ...
        total_time = (datetime.now(tz=timezone.utc) - start_time).total_seconds()
