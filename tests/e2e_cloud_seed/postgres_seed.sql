-- Seed the canonical 5-row e2e table in the PostgreSQL hub.
-- Run against the Postgres connection 8687069d-... (the e2e hub) before
-- running any e2e-postgres-to-* pipeline.
--
--   psql "$POSTGRES_URL" -f tests/e2e_cloud_seed/postgres_seed.sql
