...
// `path` is repo-relative because the artifacts no longer share a directory:
// the type-map tables are the CDK's, while the consumption manifest is
// generated by build-time tooling that must not ship inside the engine.
export const ARTIFACTS = [
  { prefix: "conversion-matrix", path: "cdk/cdk/type_map/conversion_matrix.json" },
  { prefix: "arrow-type-grammar", path: "cdk/cdk/type_map/arrow_type_grammar.json" },
  {
    prefix: "consumption-manifest",
    path: "tools/consumption_manifest/consumption_manifest.json",
  },
];
