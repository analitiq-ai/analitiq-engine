...
class StreamingEngine:
    ...
    async def _process_stream(
        ...
        try:
            ...
            dst_connection_config = merged_dst_config.get("_connection", merged_dst_config)

            # Connect to source and destination using connection configs
            await source_connector.connect(src_connection_config)
            await dest_connector.connect(dst_connection_config)
